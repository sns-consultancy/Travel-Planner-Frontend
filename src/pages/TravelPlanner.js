...
export default function TravelPlanner() {
  return (
    <div style={{ padding: "2rem" }}>
      <h2>✈️ TravelPlanner</h2>
      <p>
        Welcome to <strong>TravelPlanner</strong> — explore its unique features and capabilities.
      </p>
      ...
      <a
        href="https://travelplanner.vercel.app"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded"
      >
        Launch TravelPlanner →
      </a>
    </div>
  );
}
