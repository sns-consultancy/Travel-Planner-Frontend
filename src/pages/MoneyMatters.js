...
export default function MoneyMatters() {
  return (
    <div style={{ padding: "2rem" }}>
      <h2>💰 MoneyMatters</h2>
      <p>
        Welcome to <strong>MoneyMatters</strong> — explore its unique features and capabilities.
      </p>
      ...
      <a
        href="https://moneymatters.vercel.app"
        target="_blank"
